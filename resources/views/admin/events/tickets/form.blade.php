<x-app-layout>
    <x-slot name="header">
      <h2 class="text-xl font-semibold leading-tight text-gray-800">
        Event &raquo; {{ $event->name }} &raquo; Ticket &raquo; {{ isset($ticket) ? 'Edit' : 'Create' }}
      </h2>
    </x-slot>
        ...
        <div class="overflow-hidden shadow sm:rounded-md">
          <div class="px-4 py-5 bg-white sm:p-6">
            <form method="POST"
              ...
              <div class="mb-6">
                <label for="name" class="block mb-2 text-sm">Ticket Name</label>
              ...
              <div class="mb-6">
                <label for="quantity" class="block mb-2 text-sm">Max Buy</label>
