            ...
            <table class="w-full">
              <thead class="bg-gray-50">
                <tr>
                  ...
                  <th class="px-6 py-3">Ticket Name</th>
                  <th class="px-6 py-3">Price</th>
                  <th class="px-6 py-3">Quantity</th>
                  <th class="px-6 py-3">Max Buy</th>
                  <th style="max-width: 1%" class="px-6 py-3">Actions</th>
                </tr>
              </thead>
              <tbody>
                    ...
                    <td class="px-6 py-4">
                      ...
                      <form action="{{ route('admin.events.tickets.destroy', [
                          ...
                          'ticket' => $ticket->id,
                            ...
                            onsubmit="return confirm('Delete {{ $ticket->name }} ticket?')">
                        @csrf
                        @method('DELETE')
