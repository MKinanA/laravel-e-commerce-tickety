<x-app-layout>
    <x-slot name="header">
      <h2 class="text-xl font-semibold leading-tight text-gray-800">
        Event &raquo; {{ isset($event) ? 'Edit' : 'Create' }}
      </h2>
    </x-slot>
        ...
        <div class="overflow-hidden shadow sm:rounded-md">
          <div class="px-4 py-5 bg-white sm:p-6">
            <form method="POST"
              ...
              <div class="mb-6">
                <label for="start_time" class="block mb-2 text-sm">Start time</label>
              ...
              <div class="mb-6">
                <label for="duration" class="block mb-2 text-sm">Duration</label>
              ...
              {{-- Type (online/offline) --}}
              <div class="mb-6">
                <label for="type" class="block mb-2 text-sm">Type</label>
              ...
              {{-- Photos (multiple) --}}
              <div class="mb-6">
                <label for="files" class="block mb-2 text-sm">Photo</label>
                <input type="file" name="files[]" multiple
                       class="bg-gray-50 border border-gray-300 rounded-lg w-full p-2.5">
              </div>
              {{-- Is Popular --}}
              <div class="mb-6">
                <label for="is_popular" class="block mb-2 text-sm">Is Popular?</label>
